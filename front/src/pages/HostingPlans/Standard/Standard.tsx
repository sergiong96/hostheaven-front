            ...
            if (list) {
                list.forEach((element) => {
                    ...
                    if (name && value) {
                        ...
                        } else if (name === "storage" || name === "domains" || name === "monthly_bandwidth" || name === "databases") {
            ...
            {hostingPackages.map((data) => (
                <div key={data.id_package} id={data.id_package.toString()} className={"package " + data.package_name}>
                    ...
                    <ul className='characteristics'>
                        ...
                        <li data-name="hosting_type" data-value={data.hosting_type}><strong>Tipo hosting:</strong> {data.hosting_type}</li>
                        <li data-name="monthly_bandwidth" data-value={data.monthly_bandwidth}><strong>Ancho de banda mensual:</strong> {data.monthly_bandwidth}GB</li>
                        ...
                        <li data-name="technical_support_24h" data-value={data.technical_support_24h ? 'true' : 'false'}><strong>Soporte técnico 24 horas:</strong> {data.technical_support_24h ? <i className="fa-solid fa-check" style={{ color: 'springgreen' }}></i> : <i className="fa-solid fa-xmark" style={{ color: 'red' }}></i>}</li>
                    </ul>
