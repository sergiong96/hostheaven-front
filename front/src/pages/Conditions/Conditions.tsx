...
function Conditions() {
    ...
    return (
        <main id="conditions-page">
            ...
            <h3>LICENCIA</h3>
            <p>HostHeaven a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
